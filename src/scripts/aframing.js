let textObj = {
    frontText: {
        arrInd: 0,
        arrSize: 3,
        textArr: ["An estimated 19.1% of U.S. adults had any anxiety disorder in the past year",
    ...
    rightText: {
        arrInd: 0,
        arrSize: 2,
        textArr: ["Among adults with any anxiety disorder, an estimated 22.8% had serious impairment, and 33.7% had moderate impairment",
        "A majority of people with any anxiety disorder experienced mild impairment (43.5%)"]
    },
    backText: {
        arrInd: 0,
        arrSize: 3,
        textArr: ["Experiencing discrimination can cause psychological distress and make us much more vulnerable to depression and anxiety",
    ...
    leftText: {
        arrInd: 0,
        arrSize: 3,
        textArr: ["An estimated 31.9% of adolescents had any anxiety disorder",
